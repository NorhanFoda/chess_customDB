function bp_pos_value(game,piece, pos){
    ...
    if(piece == 'p'){
        ...
        if(front_piece != null)
        {
            if(front_piece.color == 'w' && front_piece.type == 'p')
            {
                backward = 1;
            }
        }    
    ...
    for(var i_col = 0; i_col < letters.length; i_col++){
        for(var i_row = 1; i_row <= 8; i_row++){
            if((letters[i_col]+i_row) == pos){
                ...
                if(left_piece != null && left_piece.color == 'b' && left_piece.type == 'p')
                {
                    isolated = 0;
                }
                else if(right_piece != null && right_piece.color == 'b' && right_piece.type == 'p')
                {
                    isolated = 0;
                }
                else if(top_left_piece != null && top_left_piece.color == 'b' && top_left_piece.type == 'p')
                {
                    isolated = 0;
                }
                else if(top_right_piece != null && top_right_piece.color == 'b' && top_right_piece.type == 'p')
                {
                    isolated = 0;
                }
                else if(bottom_left_piece != null && bottom_left_piece.color == 'b' && bottom_left_piece.type == 'p')
                {
                    isolated = 0;
                }
                else if(bottom_right_piece != null && bottom_right_piece.color == 'b' && bottom_right_piece.type == 'p')
                {
                    isolated = 0;
                }
                else
